...
//    var leftMeterLabel:UILabel!;
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if self.respondsToSelector(Selector("edgesForExtendedLayout")) {
         ...
         graphView = MeterGraphView(frame: CGRectMake(0, 10, meterGraphContentViewWidth, 80), params: params)
...
//         leftMeterLabel = UILabel(frame: CGRectMake((self.view.bounds.origin.x + 10),60,60,50))
         rightMeterLabel.text = "A \(rightCount)票"
         leftMeterLabel.text = "B \(leftCount)票"
